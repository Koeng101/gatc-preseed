  ...
  sections: [
    {
      paragraphs: [
        ...
        'This is a successful deep-tech company, bootstrapped, and profitable. But in our mind, also limited, in that they\'ve gotten very efficient at one specific niche (sequencing services), without building the capacities to automate other experiments — which is very difficult to integrate later. This limits their ability to become a multi-billion dollar company, as the moat to competition is relatively low — as shown by companies like Angstrom Innovation undercutting Plasmidsaurus by 3x in their core business — and the fact that adaptation slows when you need humans to run your lab.',
      ],
    },
    {
      paragraphs: [
