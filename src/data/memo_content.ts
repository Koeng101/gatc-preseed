...
export const memoSections: MemoSection[] = [
  ...
  },
  {
    ...
    subsections: [
      {
        paragraphs: [
          'Genetic Assemblies is founded by Keoni Gandall and Ben Ray. Keoni worked at UCI for 4 years in Chang Liu\'s lab in directed evolution and mitochondrial engineering, and then worked for 3 years in Drew Endy\'s lab at Stanford, running the FreeGenes Project. Afterwards, he cofounded Trilobio, a company manufacturing fully-automated lab robots. However, simply making hardware was not his calling, so he founded Genetic Assemblies, with the goal of full automation as a service. At Trilobio, Keoni was in charge of building the software systems for fully automated labs.',
          'Ben Ray has joined as cofounder. Ben led the automation team at Retro Biosciences, a large and successful longevity startup, for 3.5 years before leaving and joining Genetic Assemblies. At Retro, Ben was in charge of building and maintaining the hardware for fully automated robotic systems using used robots and clever engineering.',
    ...
    subsections: [
      {
        ...
        vizId: 'customer-pipeline',
        vizLabel: 'CUSTOMER PIPELINE',
      },
      {
        heading: 'Customer A: Cloned Plasmids — animal testing',
        paragraphs: [
          'We build and validate synthetic DNA that is used to test DNA-based drugs in animals. We charged approximately $100 per construct and have delivered 120 constructs (total revenue: $12,000). Market size: ~$2B, based on Twist\'s IPO documents.',
        ],
      },
      {
    ...
    subsections: [
      {
        paragraphs: [
          ...
          'Our hypothesis is that, like with deploying software, there will be a massive transition away from in-house labs to remote cloud labs. If we see a transition away from companies managing both the lab and the software/services on top of those labs and towards companies only managing software/services in our lab, we can create and capture billions in value.',
        ],
